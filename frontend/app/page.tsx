    ...
    <main>
      <section className="mx-auto flex min-h-[calc(100vh-80px)] max-w-7xl flex-col justify-center gap-10 px-4 py-10 sm:px-6 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Link
                href="/scan"
                className="inline-flex items-center rounded-lg bg-emerald-600 px-6 py-3 text-base font-semibold text-white shadow hover:bg-emerald-700"
              >
                Start Free Scan
              </Link>
              <a
          ...
          <div className="rounded-3xl bg-white p-8 shadow-lg">
            <div className="rounded-2xl border border-emerald-100 bg-emerald-50 p-8">
              <div className="mx-auto flex h-48 w-48 items-center justify-center rounded-full bg-white">
                <span className="text-5xl">👁</span>
              </div>
              <p className="mt-6 text-center text-sm font-bold text-slate-900">Eye Health Score</p>
              <h3 className="mt-2 text-center text-4xl font-extrabold text-emerald-700">92/100</h3>
        ...
        <div id="features" className="grid gap-6 lg:grid-cols-4">
          {[
            { title: "Multi-Disease Detection", copy: "Screen for anemia, jaundice, cataracts, and infections from a single image" },
        ...
        <section id="conditions" className="mt-10 rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            {[
              ...
              { title: "Jaundice", desc: "Sclera yellowing analysis identifies potential liver issues." },
              { title: "Cataract", desc: "Lens opacity patterns are evaluated for early cataract risk." },
              { title: "Infection", desc: "Redness and vessel patterns are scored for infection risk." },
            ].map(card => (
        ...
        <section id="how-it-works" className="mt-10 rounded-2xl border border-emerald-100 bg-white p-8 shadow-sm">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            {[
              ...
              <div key={item.step} className="rounded-xl border border-slate-200 p-6 text-center">
                <div className="mx-auto mb-4 h-12 w-12 rounded-full bg-emerald-600 text-white flex items-center justify-center font-bold">{item.step}</div>
          ...
          <div className="mt-8 text-center">
            <Link href="/scan" className="inline-flex rounded-lg bg-emerald-600 px-8 py-3 text-base font-semibold text-white hover:bg-emerald-700">
              Get Started Free
            </Link>
          </div>
        </section>
